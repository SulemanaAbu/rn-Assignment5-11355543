...
const data = [
    { id: 1, company: "Apple Store", description: "Entertainment", money: "- $5.99", image: require('../assets/apple.png') },
    ...
    { id: 5, company: "Apple Store", description: "Entertainment", money: "- $5,99", image: require('../assets/apple.png') }
]
